namespace :ptourist do
  ...
  def create_user_image(user)
    urls = [
            "http://media.mlive.com/entertainment_impact/photo/9315100-large.jpg",
            "http://s.libertaddigital.com/fotos/noticias/maude-flanders.jpg",
            "http://st-listas.20minutos.es/images/2011-08/297210/3109662_640px.jpg?1312242515"];
    url = urls.sample
    puts "downloading: #{url}"
    contents = open(url, {ssl_verify_mode: OpenSSL::SSL::VERIFY_NONE}).read
