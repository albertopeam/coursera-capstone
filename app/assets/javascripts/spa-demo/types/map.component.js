(function() {
  ...
  ImagesMapController.prototype.setActiveMarker = function(thing_id, image_id) {
    if (!this.map) {
      return;
  ...
  ImagesMapController.prototype.thingInfoWindow = function(ti) {
  ...
  ImagesMapController.prototype.imageInfoWindow = function(ti) {
